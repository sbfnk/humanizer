...
The same error has a compressed form, "X, not Y" or "X, rather than Y", where Y is an alternative the reader never considered. The negated half records the writing process and leaks it into the finished text.
**Before:**
...
### 36. Concepts acting like people
