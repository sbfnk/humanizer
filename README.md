...
- **2.11.0+sbfnk.1** - Local fork additions, carried across the Plain Language rewrite: banned words (§ "Never use these words"), the "X, not Y" compressed form and conversation-derived Y in §35, concepts acting like people (§36), and pseudo-clefts (§37). 37 patterns total.
